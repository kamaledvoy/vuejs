  ...
  <div class="container h-100">
    <div class="row mt-5" v-if="!userData">
      ...
      <div class="col-md-6 d-flex flex-column justify-content-center p-5">
        ...
        />
        <button type="button" @click="fetchData"  class="btn btn-primary" >
          Search
        </button>
      </div>
    </div>
    ...
    <div class="row mt-3" v-else>
      <div class="col-md-4">
        <user-card :userData="userData" :resetData="resetData"></user-card>
      </div>
      <div class="col-md-8">
        <repos :repos_url="repos_url"></repos>
      </div>
    </div>
  </div>
</template>
...
import Repos from "../components/Repose.vue"
...
export default {
  ...
  computed: {
    ...mapGetters(["isAuthenticated"]) //not login in user
  },
  watch: {
